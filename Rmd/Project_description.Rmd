...
<center><img src='https://github.com/Danielslee51/NEON-Hosted-Browser/blob/master/Img/Earth.jpg?raw=true' width='600' class='center'></center>
...
As an academic organization that promotes data-driven discovery and provides public cyberinfrastructure to scientists, NEON and this project fall squarely within CyVerse's mission. Attempting to further advance NEON's community-based philosophy, the CyVerse NEON Browser was one of the first apps to be unveiled on CyVerse's Interactive Discovery Environment (VICE), which hosts scientific applications publically to make them more accessible. The app, which deals with purely NEON, actually traces its origin back to the project "Calliope View" which displays drone imaging alongside ecological data (hence, NEON). Throughout the development of Calliope View, we realized that the features implemented to display and pull NEON data were very useful, and as a result we created this stand-alone tool.
...
Find out the specific packages used <a href='https://github.com/Danielslee51/NEON-Shiny-Browser#package-requirements' target='_blank'>here</a>.
