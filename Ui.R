                              ...
                              navlistPanel(widths = c(3,9), id = "tutorial",
                                           ...
                                           tabPanel("Downloading data products",
                                                    ...
                                                    tabsetPanel(id = "tutorial_download",
                                                                tabPanel(tags$b("General Download"), value = "general",
                                                                         includeMarkdown("Rmd/Help_download_general.Rmd")),
                                                                tabPanel(tags$b("Specific Download"),
                                                                         includeMarkdown("Rmd/Help_download_specific.Rmd")),
                                                                ...
                                                                tabPanel(tags$b("Stacking Downloads"),
                                                                         includeMarkdown("Rmd/Help_download_stack.Rmd")),
                                                                tabPanel(icon("forward"))
                                                    )
                                           )))#,
