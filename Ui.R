                                                        ...
                                                        tabsetPanel(
                                                          ...
                                                          tabPanel("Step 2- Download Data",
                                                                   ...
                                                                   conditionalPanel("input.NEON_download_type == 'specific'",
                                                                                    ...
                                                                                    checkboxInput(inputId = "specific_size", label = "Calculate download size"),
                                                                                    conditionalPanel("input.specific_size",
                                                                                                     actionLink(inputId = "get_specific_size", label = "Calculate size"),
                                                                                                     verbatimTextOutput(outputId = "specific_size", placeholder = TRUE)),
                                                                                    includeMarkdown('Rmd/NEON_download_message.Rmd'),
